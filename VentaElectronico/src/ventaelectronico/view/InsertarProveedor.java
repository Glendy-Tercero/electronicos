...
private ProveedorCtrl controladorProv;
    ...
    InsertarProveedor(ProveedorCtrl CtrlProveedor) {
        initComponents();
    ...
    private void initComponents() {
        ...
        TxtDireccion.setBackground(new java.awt.Color(49, 52, 63));
        TxtDireccion.setFont(new java.awt.Font("Bahnschrift", 0, 14)); // NOI18N
        TxtDireccion.setForeground(new java.awt.Color(255, 255, 255));
        TxtDireccion.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(79, 84, 102)));
    ...
    String nombre, direccion, correo, mensaje;
    int telefono;
    
        controladorProv = new ProveedorCtrl();

        nombre = this.TxtNombre.getText();
        correo = this.TxtCorreo.getText();
        direccion = this.TxtDireccion.getText();
        telefono = Integer.parseInt(this.TxtTelefono.getText());
        mensaje = controladorProv.InsertarProveedor(nombre, direccion, correo, telefono);
    ...
    private void BotonRegresar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonRegresar1ActionPerformed
        MenuPrincipal InsertarProveedor = new MenuPrincipal();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertarProveedor().setVisible(true);
            }
        });
    }
